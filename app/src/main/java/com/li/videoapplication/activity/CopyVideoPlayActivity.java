...
public class CopyVideoPlayActivity extends Activity implements View.OnClickListener,
...
//        Settings.System.putInt(getContentResolver(),Settings.System.ACCELEROMETER_ROTATION,1);
        ...
        if (CopyVideoPlayActivity.this.getIntent().getExtras()!=null){
            id=CopyVideoPlayActivity.this.getIntent().getStringExtra("id");
            titleTv=(TextView)findViewById(R.id.video_play_title);
            titleTv.setText(CopyVideoPlayActivity.this.getIntent().getStringExtra("title"));
        }
...
//        },2000);
    ...
    private void initView(){
        ...
        inflater=LayoutInflater.from(CopyVideoPlayActivity.this);
...
//        }
        ...
        adapter=new CommentAdapter(CopyVideoPlayActivity.this,list);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.video_play_back:
                stopPlay();
                CopyVideoPlayActivity.this.finish();
                break;
            case R.id.video_play_persion:
                Intent intent=new Intent(CopyVideoPlayActivity.this,LoginActivity.class);
...
//                startActivity(intent);
            ...
            case R.id.video_play_head_b_download:
                ...
                if (detail!=null){
                    ...
                    updateIntent.putExtra("img",detail.getFlagPath());
                    updateIntent.putExtra("title",detail.getName());
...
//            });
    ...
    public void touchControlBar(){
        if(mController.getVisibility() == View.INVISIBLE){
            ...
            mt.schedule(new TimerTask() {
                @Override
                public void run() {
                    CopyVideoPlayActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            mController.setVisibility(View.INVISIBLE);
                        }
    ...
    public void onRefresh() {
        ...
        asyncType=REFRESH;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB){
            new GetCommentAsync(CopyVideoPlayActivity.this,id+"",pageId+"").executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
        }else{
            new GetCommentAsync(CopyVideoPlayActivity.this,id+"",pageId+"").execute();
        }
    }
    ...
    public class GetVedioDetail extends AsyncTask<Void,Void,String>{
        ...
        protected String doInBackground(Void... params) {
            ...
            detail= JsonHelper.getVedioDetail(CopyVideoPlayActivity.this,id);
            if (detail!=null){
                return "s";
            }
            return "";
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.equals("")){
                ToastUtils.showToast(CopyVideoPlayActivity.this,"获取视频数据失败");
                return;
            }
        ...
        protected void onPostExecute(String s) {
            ...
            if (asyncType == REFRESH){
                if (s.equals("s")) {
                    ...
                    ToastUtils.showToast(CopyVideoPlayActivity.this,"连接服务器失败");
                }
            }else{
                if (s.equals("s")) {
                    if (connList.size()==0){
                        ToastUtils.showToast(CopyVideoPlayActivity.this,"已经加载全部数据");
                    }else{
                        list.addAll(connList);
                    }
    ...
    private void showShare() {
        ...
        oks.setNotification(R.drawable.tubiao, getString(R.string.app_name));
        // title标题，印象笔记、邮箱、信息、微信、人人网和QQ空间使用
        oks.setTitle(getString(R.string.share));
        // titleUrl是标题的网络链接，仅在人人网和QQ空间使用
        oks.setTitleUrl(detail.getUrl());
        // text是分享文本，所有平台都需要这个字段
        oks.setText("快来看看"+detail.getName());
        // imagePath是图片的本地路径，Linked-In以外的平台都支持此参数
//        oks.setImagePath("/sdcard/test.jpg");
        // url仅在微信（包括好友和朋友圈）中使用
        oks.setUrl(detail.getUrl());
        // comment是我对这条分享的评论，仅在人人网和QQ空间使用
//        oks.setComment("我是测试评论文本");
        // site是分享此内容的网站名称，仅在QQ空间使用
        oks.setSite(getString(R.string.app_name));
        // siteUrl是分享此内容的网站地址，仅在QQ空间使用
        oks.setSiteUrl(detail.getUrl());
    ...
    private class FlowerTask extends AsyncTask<Void,Void,String>{
        ...
        protected void onPostExecute(String b) {
            ...
            if (b.equals("c")) {
                ToastUtils.showToast(CopyVideoPlayActivity.this,"你已经赞过了该视频");
            }else if(b.equals("s")){
    ...
    private class DownloadTask extends AsyncTask<Void,Void,Boolean>{
        ...
        protected void onPostExecute(Boolean b) {
            ...
            if (b){
                ...
                ToastUtils.showToast(CopyVideoPlayActivity.this,"网络错误");
            }
        }
    }
    ...
    private class SubmitTask extends AsyncTask<Void,Void,Boolean>{
        ...
        protected void onPostExecute(Boolean b) {
            super.onPostExecute(b);
            if (b){
                ToastUtils.showToast(CopyVideoPlayActivity.this,"评论成功");
                commentEdt.setText("");
                onRefresh();
            }else{
                ToastUtils.showToast(CopyVideoPlayActivity.this,"评论失败,请重试");
            }
        }
    }
    ...
    private class CollectTask extends AsyncTask<Void,Void,String>{
        ...
        protected void onPostExecute(String b) {
            super.onPostExecute(b);
            if (b.equals("c")) {
                ToastUtils.showToast(CopyVideoPlayActivity.this,"你已经收藏过了该视频");
            }else if(b.equals("s")){


                collectTv.setText(Integer.parseInt(collectTv.getText().toString().trim().equals("")?"0":collectTv.getText().toString().trim())+1+"");
                ToastUtils.showToast(CopyVideoPlayActivity.this,"收藏视频成功");
            }else{
                ToastUtils.showToast(CopyVideoPlayActivity.this,"收藏视频失败");
            }
        }
    }
