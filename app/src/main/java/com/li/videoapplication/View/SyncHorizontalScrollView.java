...
public class SyncHorizontalScrollView extends HorizontalScrollView {
	...
	public void setSomeParam(View view, ImageView leftImage,
		...
		windowWitdh = dm.widthPixels;//屏幕的宽度
	}
	 ...
	 * 显示导向图标</br>
	 * 
	 * getWidth(): View在設定好佈局後整個View的寬度。</br>
	 * getMeasuredWidth(): 對View上的內容進行測量後得到的View內容佔據的寬度，</br>
	 * 前提是你必須在父佈局的onLayout()方法或者此View的onDraw()方法裡調 用measure(0,0);</br>
	 * (measure 參數的值你可以自己定義)，否則你得到的結果和getWidth()得到的結果一樣。</br>
	 */
